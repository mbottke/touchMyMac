...
The goal of TouchMyMac was to provide a simple, general-purpose driver that enables plug-and-play support for touchscreens on macOS. 
...
The TouchMyMac **utility app** allows you to control your Mac with any connected touch screen. TouchMyMac supports clicks, dragging, scrolling, and pinch-to-zoom.
...
### Installing the App
- Compile the app or [download the latest notarized build here](https://github.com/shueber/TouchMyMac/releases).
...
### Compatibility
TouchMyMac should work with any touchscreen that also works with Windows.
...
The TouchMyMac app itself is an example of integrating the TouchUpCore framework. You can have a look at the *DebugView* to see how you can visualize the different touch points. Remember that your app needs an Entitlement to access USB if running in the Sandbox.
